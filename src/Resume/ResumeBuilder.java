...
public class ResumeBuilder {
	...
	private JTextField Intrest1;
	private JTextField Intrest4;
	private JTextField Intrest5;
	private JTextField Intrest2;
	private JTextField Intrest3;
	private JTextField Intrest6;
...
//		============================================================================================================
		...
		Intrest1 = new JTextField();
		Intrest1.setForeground(new Color(25, 25, 112));
		Intrest1.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
		Intrest1.setColumns(10);
		Intrest1.setBorder(new LineBorder(new Color(192, 192, 192), 1, true));
		Intrest1.setBackground(UIManager.getColor("Button.background"));
		Intrest1.setBounds(44, 298, 230, 21);
		ExtD_panel.add(Intrest1);
		
		JLabel Intrust_Label_1 = new JLabel("Intrest 1");
		...
		JLabel Intrust_Label_4 = new JLabel("Intrest 4");
		...
		Intrest4 = new JTextField();
		Intrest4.setForeground(new Color(25, 25, 112));
		Intrest4.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
		Intrest4.setColumns(10);
		Intrest4.setBorder(new LineBorder(new Color(192, 192, 192), 1, true));
		Intrest4.setBackground(UIManager.getColor("Button.background"));
		Intrest4.setBounds(44, 363, 230, 21);
		ExtD_panel.add(Intrest4);
		
		Intrest5 = new JTextField();
		Intrest5.setForeground(new Color(25, 25, 112));
		Intrest5.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
		Intrest5.setColumns(10);
		Intrest5.setBorder(new LineBorder(new Color(192, 192, 192), 1, true));
		Intrest5.setBackground(UIManager.getColor("Button.background"));
		Intrest5.setBounds(306, 363, 230, 21);
		ExtD_panel.add(Intrest5);
		
		JLabel Intrust_Label_5 = new JLabel("Intrest 5");
		...
		JLabel Intrust_Label_2 = new JLabel("Intrest 2");
		...
		Intrest2 = new JTextField();
		Intrest2.setForeground(new Color(25, 25, 112));
		Intrest2.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
		Intrest2.setColumns(10);
		Intrest2.setBorder(new LineBorder(new Color(192, 192, 192), 1, true));
		Intrest2.setBackground(UIManager.getColor("Button.background"));
		Intrest2.setBounds(306, 298, 230, 21);
		ExtD_panel.add(Intrest2);
		
		Intrest3 = new JTextField();
		Intrest3.setForeground(new Color(25, 25, 112));
		Intrest3.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
		Intrest3.setColumns(10);
		Intrest3.setBorder(new LineBorder(new Color(192, 192, 192), 1, true));
		Intrest3.setBackground(UIManager.getColor("Button.background"));
		Intrest3.setBounds(568, 298, 230, 21);
		ExtD_panel.add(Intrest3);
		
		JLabel Intrust_Label_3 = new JLabel("Intrest 3");
		...
		JLabel Intrust_Label_6 = new JLabel("Intrest 6");
		...
		Intrest6 = new JTextField();
		Intrest6.setForeground(new Color(25, 25, 112));
		Intrest6.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
		Intrest6.setColumns(10);
		Intrest6.setBorder(new LineBorder(new Color(192, 192, 192), 1, true));
		Intrest6.setBackground(UIManager.getColor("Button.background"));
		Intrest6.setBounds(568, 363, 230, 21);
		ExtD_panel.add(Intrest6);
		
		JLabel lblNewLabel_8_1 = new JLabel("Intrest");
...
//				--------------------------RESUME VIEW PAGE-------------------------------
				...
				String resumePtah = "D:/"+ First_Name.getText() +"_"+ Second_Name.getText() +"_Resume.pdf";
...
//				-------------------------------------------------------------------------
				...
				System.out.println("PATH:"+"\n"+"\t \t" +"D:/"+ First_Name.getText() +"_"+ Second_Name.getText() +"_Resume.pdf");
				System.out.println("--------------------------------------------------------------");
